...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUsuario.setBounds(160, 339, 146, 28);
        ...
        txtEmail.setBounds(160, 379, 146, 28);
        ...
        txtSenha.setBounds(160, 419, 146, 28);
        ...
        btnCriarConta.setBounds(182, 460, 103, 24);
        ...
        btnEntrar.setBounds(182, 490, 101, 25);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/telas/LoginAAPE.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(0, 0, 440, 800);
        ...
        btnEsqueceuSenha.setBounds(195, 520, 80, 20);

        setSize(new java.awt.Dimension(453, 800));
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        // Códigos do botão:
        try {
            ResultSet resultado = AapeDao.fazerLogin (txtUsuario.getText(), txtEmail.getText(), txtSenha.getText());
